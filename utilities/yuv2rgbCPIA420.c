/*
 ...
 $Id: yuv2rgbCPIA420.c,v 1.1 2002/05/22 04:57:22 dirkx Exp $
*/
...
#pragma unused(ul8)
    ...
    srcRow1Extra=2*srcRowExtra+4*width;		//skip line 2 since we're working two lines at once
    srcRow2Extra=2*srcRowExtra+8*width;		//skip line 1 since we're working two lines at once
    d1=dst;
...
//Extract yuv pixel data
            ...
            y13=(ul2&0xff000000)>>16;
            u2 =((ul2&0x00ff0000)>>16)-128;
            y14=(ul2&0x0000ff00);
            v2 =(ul2&0x000000ff)-128;
            y21=(ul3&0xff000000)>>16;
            y22=(ul3&0x00ff0000)>>8;
            y23=(ul3&0x0000ff00);
            y24=(ul3&0x000000ff)<<8;
