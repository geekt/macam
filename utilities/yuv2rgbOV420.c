/*
 ...
 $Id: yuv2rgbOV420.c,v 1.2 2002/10/28 23:24:33 himori Exp $
*/
...
*/
    unsigned char* s1;				//Source buffer run: y first line
    unsigned char* s2;				//Source buffer run: y second line
    unsigned char* s3;				//Source buffer run: u line
    unsigned char* s4;				//Source buffer run: v line
...
//Extract yuv pixel data
            ...
            u1 =((us1&0x0000ff00)>>8)-128;
            u2 =(us1&0x000000ff)-128;
            v1 =((us2&0x0000ff00)>>8)-128;
            v2 =(us2&0x000000ff)-128;
