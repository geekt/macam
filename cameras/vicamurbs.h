/*
 vicamurbs.h - Vista Imaging ViCAM / 3Com HomeConnect Usermode Driver

 (C) 2001 Christopher L Cheney
 ...
 $Id: vicamurbs.h,v 1.1 2002/07/08 22:32:01 mattik Exp $
...
/* 128x98 ? 0x3180 size */
unsigned char s128x98bw[] = {
  0xAE, 0x34, 0xC4, 0x00, 0x00, 0x00, 0x03, 0x01,
  0x18, 0x02, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00
};

/* 128x122 3D80 size */
unsigned char s128x122bw[] = {
  0xAE, 0x34, 0xF4, 0x00, 0x00, 0x00, 0x03, 0x01,
  0x00, 0x02, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00
};

/* 256x242 ? 0xF280 size */
/* BA 03 C8 03 00 00 03 01 00 04 00 00 40 00 00 00 */
unsigned char s256x242bw[] = {
  0xAE, 0x03, 0xC8, 0x03, 0x00, 0x00, 0x03, 0x01,
  0x00, 0x04, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00
};

/* 512x242 0x1E480 size */
unsigned char s512x242bw[] = {
  0xAE, 0x05, 0x90, 0x07, 0x00, 0x00, 0x03, 0x01,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

unsigned char joes[] = {
  0x7f, 0x00, 0x90, 0x07, 0x00, 0x00, 0x59, 0x04,
  0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

/* -------------------------------------------------------------------------- */

/* Request 0xFF Vendor Specific ? */

unsigned char firmware1[] = {
...
unsigned char findex1[] = {
  0xB6, 0xC3, 0x03, 0x00, 0x03, 0x64,

  0x18, 0x00, 0x00, 0x00
};

unsigned char fsetup[] = {
...
/* 1680 bytes of payload */
unsigned char firmware2[] = {
