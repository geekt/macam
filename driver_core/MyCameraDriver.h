/*
 ...
 $Id: MyCameraDriver.h,v 1.3 2002/10/24 18:16:59 mattik Exp $
*/
...
- (BOOL) usbWriteCmdWithBRequest:(short)bReq wValue:(short)wVal wIndex:(short)wIdx buf:(void*)buf len:(short)len;//Sends command to pipe 0
